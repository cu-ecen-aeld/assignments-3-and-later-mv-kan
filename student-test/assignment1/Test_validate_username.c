...
void test_validate_my_username()
{
    ...
    const char* expecteduser = my_username();
    char* actualuser = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(expecteduser, actualuser, "must be equal");
}
